...
foreach(_cmake_expected_target IN ITEMS TKService TKV3d TKOpenGl TKMeshVS TKIVtk)
...
set_target_properties(TKV3d PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/opencascade"
  INTERFACE_LINK_LIBRARIES "TKBRep;TKMath;TKernel;TKService;TKShHealing;TKTopAlgo;TKG2d;TKG3d;TKGeomBase;TKMesh;TKGeomAlgo;TKHLR"
)
...
set_target_properties(TKOpenGl PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/opencascade"
  INTERFACE_LINK_LIBRARIES "TKernel;TKService;TKMath"
)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/OpenCASCADEVisualizationTargets-*.cmake")
