...
set_target_properties(TKService PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKService.so.7.9.2"
  IMPORTED_SONAME_RELEASE "libTKService.so.7.9"
  )

list(APPEND _cmake_import_check_targets TKService )
list(APPEND _cmake_import_check_files_for_TKService "${_IMPORT_PREFIX}/lib/libTKService.so.7.9.2" )
...
set_target_properties(TKV3d PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKV3d.so.7.9.2"
  IMPORTED_SONAME_RELEASE "libTKV3d.so.7.9"
  )

list(APPEND _cmake_import_check_targets TKV3d )
list(APPEND _cmake_import_check_files_for_TKV3d "${_IMPORT_PREFIX}/lib/libTKV3d.so.7.9.2" )
...
set_target_properties(TKOpenGl PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKOpenGl.so.7.9.2"
  IMPORTED_SONAME_RELEASE "libTKOpenGl.so.7.9"
  )

list(APPEND _cmake_import_check_targets TKOpenGl )
list(APPEND _cmake_import_check_files_for_TKOpenGl "${_IMPORT_PREFIX}/lib/libTKOpenGl.so.7.9.2" )
...
set_target_properties(TKMeshVS PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKMeshVS.so.7.9.2"
  IMPORTED_SONAME_RELEASE "libTKMeshVS.so.7.9"
  )

list(APPEND _cmake_import_check_targets TKMeshVS )
list(APPEND _cmake_import_check_files_for_TKMeshVS "${_IMPORT_PREFIX}/lib/libTKMeshVS.so.7.9.2" )
...
set_target_properties(TKIVtk PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libTKIVtk.so.7.9.2"
  IMPORTED_SONAME_RELEASE "libTKIVtk.so.7.9"
  )

list(APPEND _cmake_import_check_targets TKIVtk )
list(APPEND _cmake_import_check_files_for_TKIVtk "${_IMPORT_PREFIX}/lib/libTKIVtk.so.7.9.2" )
