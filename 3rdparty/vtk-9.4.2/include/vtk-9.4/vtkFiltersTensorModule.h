...
#      define VTKFILTERSTENSOR_EXPORT __attribute__((visibility("default")))
#    else
...
#    define VTKFILTERSTENSOR_NO_EXPORT __attribute__((visibility("hidden")))
#  endif
#endif

#ifndef VTKFILTERSTENSOR_DEPRECATED
#  define VTKFILTERSTENSOR_DEPRECATED __attribute__ ((__deprecated__))
#endif
